...
async function seedDashboardData() {
  ...
  const streetNames = ['Jl. Merpati', 'Jl. Rajawali', 'Jl. Elang'];
  ...
  for (let fId = 1; fId <= 8; fId++) {
    ...
    await db.insert(schema.feePayments).values({
      ...
      paymentDate: hasPaid ? '2026-07-05' : null,
