...
export function ExpenseSkeleton() {
  return (
    <div className="space-y-6 pb-12 animate-pulse overflow-hidden" aria-busy="true" aria-label="Memuat pengeluaran kas">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="h-10 w-48 bg-gray-border/70 rounded-xl shrink-0 self-start sm:self-auto" />
      </div>
          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead className="border-b border-gray-border bg-gray-sidebar-hover/90 text-gray-secondary-text font-bold tracking-wider">
              <tr>
                ...
                <th className="py-4 px-5">Jumlah Keluar</th>
                <th className="py-4 px-5">Petugas & Bukti</th>
