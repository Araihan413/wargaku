      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
        ...
        <div>
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-border rounded-xl hover:bg-gray-sidebar-hover text-xs font-bold text-gray-heading-main transition cursor-pointer w-full"
          >
