  ...
  useEffect(() => {
    if (dwelling) {
      reset({
        ...
        coordinates: dwelling.latitude && dwelling.longitude ? `${dwelling.latitude}, ${dwelling.longitude}` : "",
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-hidden">
          <div className="flex-1 overflow-y-auto p-6 space-y-4 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-border/50 [&::-webkit-scrollbar-thumb]:rounded-full">
            ...
            <div className="flex items-center gap-2 py-2">
              ...
              />
              <label htmlFor="isActive" className="text-sm font-semibold text-black/80 tracking-wider cursor-pointer">
                Hunian Fisik Aktif
              </label>
            </div>
