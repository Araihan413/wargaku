...
export function ActivitiesSkeleton() {
  return (
    <div className="space-y-6 pb-12 animate-pulse overflow-hidden" aria-busy="true" aria-label="Memuat kelola kegiatan RT">
      ...
      {/* 3. List Kartu Kegiatan Skeleton (Layar Awal) */}
        ...
        {Array.from({ length: 3 }).map((_, idx) => (
          ...
          >
            <div className="flex items-start gap-3.5 flex-1 pr-4">
              {/* Date Box Icon */}
              <div className="h-12 w-12 rounded-xl bg-gray-border/80 shrink-0 hidden sm:block" />

              <div className="space-y-2 flex-1">
                <div className="flex flex-wrap items-center gap-2">
                  <div className="h-4 w-24 bg-gray-border/60 rounded" />
                  <div className="h-4 w-32 bg-gray-border/50 rounded" />
                </div>
