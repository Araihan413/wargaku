...
export const QrSettingCard: React.FC<QrSettingCardProps> = ({
  ...
  onTitleChange,
  onSubtitleChange,
  sampleQrUrl = "https://wargaku.app/scan-qr?token=CONTOH-A1-12",
  sampleLabel = "Contoh: Blok A1 No. 12",
}) => {
  return (
    <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs space-y-6">
      ...
      <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium">
            Sesuaikan format ukuran cetak, judul, dan subjudul. Pratinjau di samping akan langsung memperbarui tampilan.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          {/* Pilihan Ukuran / Format Cetak pakai CustomSelect */}
          <div>
            <CustomSelect
        ...
        {/* Live Preview Side Panel (5 Cols) */}
