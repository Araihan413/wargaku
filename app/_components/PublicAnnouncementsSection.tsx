...
export const PublicAnnouncementsSection: React.FC<PublicAnnouncementsSectionProps> = ({
  ...
  const displayItems = announcements.length > 0 ? announcements : [
    {
      id: 1,
      title: "Kerja Bakti Lingkungan (Seluruh Lingkungan RT 03)",
      content: "Mari bersama menjaga kebersihan lingkungan kita.",
      category: "umum" as const,
      isPinned: false,
      publishedAt: null,
      createdAt: new Date().toISOString(),
      creatorName: "Pengurus RT",
    },
    {
      id: 2,
      title: "Kerja Bakti Lingkungan (Seluruh Lingkungan RT 03)",
      content: "Mari bersama menjaga kebersihan lingkungan kita.",
      category: "penting" as const,
      isPinned: false,
      publishedAt: null,
      createdAt: new Date().toISOString(),
      creatorName: "Pengurus RT",
