...
const getPageTitle = (pathname: string): string => {
  ...
  if (pathname.startsWith("/dashboard/system-broadcast")) return "Broadcast Sistem";
  ...
  if (pathname === "/dashboard/cash" || pathname.startsWith("/dashboard/cash/reports")) return "Laporan Keuangan RT";
  if (pathname.startsWith("/dashboard/cash/income")) return "Catat Pemasukan Kas";
  if (pathname.startsWith("/dashboard/cash/expense")) return "Catat Pengeluaran Kas";
  if (pathname.startsWith("/dashboard/dues/manage")) return "Kelola & Setor Iuran";
  if (pathname.startsWith("/dashboard/dues/arrears")) return "Laporan Tunggakan Iuran";
  ...
  if (pathname.startsWith("/dashboard/neighborhood")) return "Peta Tetangga Lingkungan";
  if (pathname.startsWith("/dashboard/my-fees")) return "Tagihan & Riwayat Iuran";
  if (pathname.startsWith("/dashboard/notifications")) return "Notifikasi Sistem";
  if (pathname.startsWith("/dashboard/profile")) return "Profil Pengguna";
